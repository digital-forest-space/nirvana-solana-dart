...
/// Fetch the latest navCBBTC price and floor price
///
/// Usage: dart scripts/samsara/fetch_nav_cbbtc_price.dart [--rpc <url>] [--verbose]
///
/// Environment:
...
void main(List<String> args) async {
  ...
  if (verbose) {
    print('Fetching navCBBTC prices...');
    print('RPC: $rpcUrl');
    print('');
  }
  ...
  final market = NavTokenMarket.navCbBtc();
  ...
  if (verbose) {
    print('Floor price: ${floorPrice.toStringAsFixed(8)} ${market.baseName}');
    if (priceResult.hasPrice) {
      print('Market price: ${priceResult.price!.toStringAsFixed(8)} ${market.baseName}');
