...
void main(List<String> args) async {
  if (args.length < 2) {
    print('Usage: dart scripts/samsara/deposit_nav.dart <keypair_path> <amount> [options]');
    print('');
    print('Deposits navToken (e.g., navSOL) from your wallet into the market escrow.');
    print('');
    print('Options:');
    print('  --market <name>  Market to deposit to (default: navSOL)');
