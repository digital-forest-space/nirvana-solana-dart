...
void main(List<String> args) async {
  if (args.length < 2) {
    LogService.log('Usage: dart scripts/samsara/withdraw_nav.dart <keypair_path> <amount> [options]');
    LogService.log('');
    LogService.log('Withdraws navToken (e.g., navSOL) from the market escrow back to your wallet.');
    LogService.log('');
    LogService.log('Options:');
    LogService.log('  --market <name>  Market to withdraw from (default: navSOL)');
