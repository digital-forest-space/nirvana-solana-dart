...
void main(List<String> args) async {
  if (args.length < 2) {
    print('Usage: dart scripts/samsara/repay.dart <keypair_path> <amount> [options]');
    print('');
    print('Repays borrowed base token (e.g., SOL) to a navToken market.');
    print('');
    print('Options:');
    print('  --market <name>  Market to repay to (default: navSOL)');
